      ...
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        <div className="max-w-3xl">
          ...
          <p className="mt-2 text-sm sm:text-[15px] text-gray-600">
            Tell patients who you are and what you specialise in. You can update these details
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex items-center justify-between pt-2 gap-4 flex-wrap">
            <p className="text-xs text-gray-500 max-w-md">
              Patients will see your name, specialization, and contact details on appointments
              and messages. Please keep them accurate and up to date.
            </p>
